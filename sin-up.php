                            ...
                            <div class="popuptext" id="myPopup">
                              ...
                              <div class="lock-popup">
                                ...
                                <div class="banner-btn8">
                                  <a href="sgin-in.html"><span></span> SIGN IN</a>
                                </div>
        ...
        <div class="form-horizontal">
            ...
            <form action="server.php" method="POST" >
                ...
                <div class="mb-3 pt-5 ">
                    ...
                    <input type="text" class="col" name="firest" placeholder="First Name" value="">
                </div>
                <div class="mb-3">
                    <i class="fa-solid fa-user-tie i"></i>
                    <input type="text" class="col" name="last" placeholder="Last Name" value="">
                </div>
                <div class="mb-3">
                    ...
                    ?>
                    <span style="color:red;position:relative;top:5px;display:block;">This email already exists</span>
                    <?php else : ?>
                    <span></span>
                    <?php endif; ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="col" name="adresse" placeholder="Adress" value="">
                </div>
                <div class="mb-3">
                    <i class="fa-solid fa-fingerprint i"></i>
                    <input type="text" class="col" name="telephone" placeholder="telephone" value="">
                </div>
                <div class="mb-3 ">
